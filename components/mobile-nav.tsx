        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right">
                ...
                <div className="flex flex-col gap-3 mt-3">
                    <MobileLink onOpenChange={setOpen} href="/blog"> The Thought Space </MobileLink>
...
function MobileLink({ href, onOpenChange, children, className, ...props}: MobileLinkProps) {
    ...
    return (
      <Link href={href} onClick={() => { router.push(href.toString()); onOpenChange?.(false); }} className={className} {...props}> {children} </Link>
    );
}